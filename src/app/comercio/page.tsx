...
export async function generateMetadata({
  ...
  const title = `${categoriaNome} em Biguaçu | Portal Biguaçu`;
  const description = `Explore os melhores ${categoriaNome.toLowerCase()} em Biguaçu. Descubra serviços locais, empresas e muito mais na sua região.`;
  const keywords = [
    categoriaNome,
    "comércio local",
    "serviços",
